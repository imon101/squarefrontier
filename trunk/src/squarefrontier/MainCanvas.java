...
public class MainCanvas extends GameCanvas implements Runnable {
    ...
    MainCanvas(sfMidlet master) throws IOException {
        super(true);
        _master=master;
        _living=false;
        _fly = createFly();
    ...
    private void render(Graphics g) {
        ...
        _layerManager.paint(g, x, y);

        g.setColor(0x202040);
        g.drawRect(x, y, Constants.SCREEN_WIDTH, Constants.SCREEN_HEIGHT);
        /*
        g.drawLine(x, y,
                Constants.SCREEN_WIDTH, y);
        g.drawLine(x, Constants.SCREEN_HEIGHT + y,
